...
public static class Lib
{
    ...
    [DllImport(name, EntryPoint = "UwcGetHasNewTex")]
    public static extern bool GetHasNewTex(int id);
    
    [DllImport(name, EntryPoint = "UwcSetHasNewTex")]
    public static extern void SetHasNewTex(int id, bool state);
